...
public let SourceLangSwiftTypeIdentifier = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.typeidentifier")
public let SourceLangSwiftBuildConfigKeyword = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.buildconfig.keyword")
public let SourceLangSwiftConfigId = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.buildconfig.id")
public let SourceLangSwiftAttributeId = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.attribute.id")
public let SourceLangSwiftAttributeBuiltin = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.attribute.builtin")
...
public let SourceLangSwiftStringInterpolation = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.string_interpolation_anchor")
public let SourceLangSwiftComment = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.comment")
public let SourceLangSwiftDocComment = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.doccomment")
public let SourceLangSwiftDocCommentField = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.doccomment.field")
public let SourceLangSwiftCommentMarker = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.comment.mark")
public let SourceLangSwiftCommentURL = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.comment.url")
public let SourceLangSwiftPlaceholder = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.placeholder")
public let SourceLangSwiftObjectLiteral = sourcekitd_uid_get_from_cstr("source.lang.swift.syntaxtype.objectliteral")
